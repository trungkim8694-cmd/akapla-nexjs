...
(function(appengine_v1) {
    ...
    class Resource$Projects$Locations$Applications$Services$Versions {
        ...
        constructor(context){
            this.context = context;
            this.instances = new Resource$Projects$Locations$Applications$Services$Versions$Instances(this.context);
        }
        delete(paramsOrCallback, optionsOrCallback, callback) {
            let params = paramsOrCallback || {};
            let options = optionsOrCallback || {};
    ...
    class Resource$Projects$Locations$Applications$Services$Versions$Instances {
        context;
        constructor(context){
            this.context = context;
        }
        debug(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/projects/{projectsId}/locations/{locationsId}/applications/{applicationsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}:debug').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
        ...
        delete(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/projects/{projectsId}/locations/{locationsId}/applications/{applicationsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'DELETE',
                    apiVersion: ''
                }, options),
                params,
    ...
    appengine_v1.Resource$Projects$Locations$Applications$Services$Versions$Instances = Resource$Projects$Locations$Applications$Services$Versions$Instances;
...
(function(appengine_v1beta) {
    ...
    class Resource$Projects$Locations$Applications$Services$Versions$Instances {
        ...
        debug(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta/projects/{projectsId}/locations/{locationsId}/applications/{applicationsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}:debug').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    appengine_v1beta.Resource$Projects$Locations$Applications$Services$Versions$Instances = Resource$Projects$Locations$Applications$Services$Versions$Instances;
    class Resource$Projects$Locations$Operations {
        context;
        constructor(context){
            this.context = context;
